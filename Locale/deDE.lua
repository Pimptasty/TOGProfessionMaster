...
L["SettingsGuildMode"]      = "Nur-Gilde-Synchronisationsmodus (private Server)"
L["SettingsGuildModeDesc"]  = "Für private oder emulierte Server (z. B. Whitemane), die Addon-Nachrichten nicht über Flüstern zustellen, wodurch Gildenmitglieder die Berufsdaten der anderen nicht empfangen. Wenn AKTIV, wird der gesamte Synchronisationsverkehr stattdessen über den Gildenkanal geleitet. Aktiviere dies nur, wenn die Gildensynchronisation auf deinem Server nicht funktioniert. |cffffd100Alle in der Gilde sollten es aktivieren|r — es hilft nur zwischen Mitgliedern, die es beide aktiviert haben. Gildenübergreifendes Teilen wird automatisch deaktiviert, solange dies aktiv ist. Gilt für jeden Charakter auf diesem Realm. (Ausgeblendet, wenn deine installierte DeltaSync-Version es nicht unterstützt.)"
...
L["SettingsCrafterAlertSuppressAudio"]     = "Warnton unterdr\195\188cken"
L["SettingsCrafterAlertSuppressAudioDesc"] = "Deaktiviert den Ton, wenn ein Handwerker online geht (Bildschirmblitz und Chat-Nachricht erscheinen weiterhin)."
L["SettingsCrafterAlertSuppressVisual"]    = "Optische Warnung unterdr\195\188cken"
L["SettingsCrafterAlertSuppressVisualDesc"] = "Deaktiviert die optische Bildschirmwarnung (Bildschirmblitz, Banner usw.), wenn ein Handwerker online geht (Ton und Chat-Nachricht erscheinen weiterhin)."
L["AlertCrafterOnlineBanner"]              = "Gildenhandwerker online"
L["SettingsCrafterAlertSound"]             = "Alarmton"
L["SettingsCrafterAlertSoundDesc"]         = "Welcher Ton abgespielt wird, wenn ein erreichbarer Handwerker online geht. Bei Auswahl wird eine Vorschau abgespielt. Ohne Wirkung, solange der Alarmton oben unterdr\195\188ckt wird."
L["SettingsCrafterAlertVisual"]            = "Alarm-Bildschirmeffekt"
L["SettingsCrafterAlertVisualDesc"]        = "Welcher Bildschirmeffekt ausgel\195\182st wird, wenn ein Handwerker online geht \226\128\148 ein Vollbildblitz in eurer gew\195\164hlten F\195\164rbung oder ein Blinken in der Taskleiste, falls ihr weggetabbt seid. Bei Auswahl wird eine Vorschau abgespielt. Ohne Wirkung, solange der Bildschirmblitz oben unterdr\195\188ckt wird."
