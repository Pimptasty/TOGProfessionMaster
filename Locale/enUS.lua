...
L["SyncLogPause"]       = "Pause"
L["SyncLogResume"]      = "Resume"
L["SyncLogPausedNote"]  = "  |cffffcc00(paused \226\128\148 %d buffered)|r"
...
L["CraftSearchDesc"]      = "Filter recipes by name or by what they do. Searches the enriched effect text too, so \"5 damage\", \"agility\", or \"mining\" all find matching recipes. Type a crafter's name to list every recipe that player can make."
...
L["BrowserSkillTier"]      = "Skill tier"
L["BrowserSkillTierTip"]   = "Skill Tier Filter"
L["BrowserSkillTierDesc"]  = "Show only recipes in the ticked skill tiers. Untick lower tiers to hide their recipes from the list. Tick multiple tiers; the menu stays open. Use Select All / Clear All at the bottom. Recipes with no known skill level always stay visible."
L["FilterSelectAll"]       = "Select All"
L["FilterClearAll"]        = "Clear All"
-- Trainer-rank names for the skill-tier bands (numeric range appended in code).
...
-- Guild tab
L["GuildTabChars"]          = "%d characters tracked"
L["GuildColProfession"]     = "Profession"
L["GuildColProfessionDesc"] = "Each profession and how many guild characters have it. Expand a profession to see every specialization (shown even at zero), then expand a specialization to list its characters."
L["GuildColCount"]          = "Characters"
L["GuildColCountDesc"]      = "Number of guild characters with the profession (or specialization). Counted from synced skills plus everyone known to craft its recipes."
L["GuildUnspecialized"]     = "Unspecialized"
L["GuildTabEmpty"]          = "No profession data yet. It fills in as guildmates running the addon sync their skills."
-- Guild tab help ("i" tooltip)
L["GuildHelpTitle"]         = "Guild Professions"
L["GuildHelpIntro"]         = "A headcount of the guild's crafting capacity: how many characters have each profession, broken down by specialization."
L["GuildHelpExpand"]        = "Click a profession to expand its specializations, then click a specialization to list the characters in it (online first, offline greyed). Professions without specializations expand straight to the character list."
L["GuildHelpSpecs"]         = "Every specialization is listed even at zero, so you can spot coverage gaps at a glance. A character's spec comes from their learned specialization, or is inferred from the spec-only recipes they are known to craft."
L["GuildHelpCoverage"]      = "Counts include everyone the addon knows: synced profession skills plus every character seen crafting the profession's recipes \226\128\148 not only players running the addon."
...
L["MissingSubtabPersonal"]      = "My Character"
L["MissingSubtabGuild"]         = "Guild"
L["MissingAllProfessions"]      = "All Professions"
L["MissingGuildNoData"]         = "|cffaaaaaa(no guild recipe data yet \226\128\148 it fills in as guildmates running the addon sync their recipes)|r"
L["MissingNoneFound"]           = "|cff00ff00All known recipes for this profession have been learned.|r"
L["MissingGuildNoneFound"]      = "|cff00ff00The guild collectively knows every recipe for this profession.|r"
