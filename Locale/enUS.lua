...
L["CraftMissingMaterialsDesc"] = "Appears when you don't have enough of at least one reagent to craft this recipe. Each reagent's count reads bank / bags / needed — bank is the snapshot from your last visit to your personal bank, bags is live. Red means bank + bags is still short of what's needed."
...
L["SettingsUseAuctionatorDesc"]            = "When Auctionator is installed, use its Auction House price database for crafting cost. Off by default — TOGPM uses its own prices, auto-scanned when you open the Auction House, plus the built-in vendor prices. Turn this on to prefer Auctionator's data instead."
