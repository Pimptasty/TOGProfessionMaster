...
L["SettingsSyncHeader"]     = "Synchronisation"
L["SettingsGuildMode"]      = "Mode de synchronisation guilde uniquement (serveurs privés)"
L["SettingsGuildModeDesc"]  = "Pour les serveurs privés ou émulés (p. ex. Whitemane) qui ne distribuent pas les messages d'addon via les chuchotements, ce qui empêche les membres de la guilde de recevoir les données de métier des autres. Lorsque ACTIVÉ, tout le trafic de synchronisation passe par le canal de guilde à la place. N'activez ceci que si la synchronisation de guilde ne fonctionne pas sur votre serveur. |cffffd100Tout le monde dans la guilde devrait l'activer|r — cela ne fonctionne qu'entre les membres qui l'ont tous les deux activé. Le partage inter-guildes est automatiquement désactivé tant que ceci est actif. S'applique à tous les personnages de ce royaume. (Masqué si votre version installée de DeltaSync ne le prend pas en charge.)"
...
L["SettingsCrafterAlertSuppressAudio"]     = "Supprimer le son d’alerte"
L["SettingsCrafterAlertSuppressAudioDesc"] = "Désactive le son lorsqu’un artisan se connecte (le clignotement d’écran et le message de chat restent affichés)."
L["SettingsCrafterAlertSuppressVisual"]    = "Supprimer l’alerte visuelle"
L["SettingsCrafterAlertSuppressVisualDesc"] = "Désactive l’alerte visuelle à l’écran (clignotement d’écran, bannière, etc.) lorsqu’un artisan se connecte (le son et le message de chat restent affichés)."
L["AlertCrafterOnlineBanner"]              = "Artisan de guilde connecté"
L["SettingsCrafterAlertSound"]             = "Son d’alerte"
L["SettingsCrafterAlertSoundDesc"]         = "Quel son est joué lorsqu’un artisan que vous pouvez atteindre se connecte. En sélectionner un le prévisualise. Sans effet tant que le son d’alerte est supprimé ci-dessus."
L["SettingsCrafterAlertVisual"]            = "Effet visuel d’alerte"
L["SettingsCrafterAlertVisualDesc"]        = "Quel effet à l’écran se déclenche lorsqu’un artisan se connecte — un flash plein écran dans la teinte de votre choix, ou un clignotement dans la barre des tâches lorsque vous êtes sur une autre fenêtre. En sélectionner un le prévisualise. Sans effet tant que le clignotement d’écran est supprimé ci-dessus."
