...
L["SettingsCrafterAlertSuppressAudio"]     = "Sopprimi suono di avviso"
L["SettingsCrafterAlertSuppressAudioDesc"] = "Disabilita il suono quando un artigiano si collega (il lampeggio dello schermo e il messaggio in chat appaiono comunque)."
L["SettingsCrafterAlertSuppressVisual"]    = "Sopprimi avviso visivo"
L["SettingsCrafterAlertSuppressVisualDesc"] = "Disabilita l'avviso visivo a schermo (lampeggio dello schermo, banner, ecc.) quando un artigiano si collega (il suono e il messaggio in chat appaiono comunque)."
L["AlertCrafterOnlineBanner"]              = "Artigiano della gilda online"
L["SettingsCrafterAlertSound"]             = "Suono dell'avviso"
L["SettingsCrafterAlertSoundDesc"]         = "Quale suono viene riprodotto quando un artigiano che puoi raggiungere si collega. Selezionandone uno lo si ascolta in anteprima. Non ha effetto mentre il suono dell'avviso è soppresso sopra."
L["SettingsCrafterAlertVisual"]            = "Effetto visivo dell'avviso"
L["SettingsCrafterAlertVisualDesc"]        = "Quale effetto a schermo si attiva quando un artigiano si collega — un lampo a schermo intero nella tinta che scegli, o un lampeggio nella barra delle applicazioni per quando sei in un'altra finestra. Selezionandone uno lo si vede in anteprima. Non ha effetto mentre il lampeggio dello schermo è soppresso sopra."
