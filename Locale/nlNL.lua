...
L["SettingsCrafterAlertSuppressAudio"]     = "Onderdruk waarschuwingsgeluid"
L["SettingsCrafterAlertSuppressAudioDesc"] = "Schakelt het geluid uit wanneer een crafter online komt (schermknippering en chatbericht verschijnen nog steeds)."
L["SettingsCrafterAlertSuppressVisual"]    = "Onderdruk visuele waarschuwing"
L["SettingsCrafterAlertSuppressVisualDesc"] = "Schakelt de visuele waarschuwing op het scherm (schermknippering, banner, enz.) uit wanneer een crafter online komt (geluid en chatbericht verschijnen nog steeds)."
L["AlertCrafterOnlineBanner"]              = "Gilde-crafter online"
L["SettingsCrafterAlertSound"]             = "Waarschuwingsgeluid"
L["SettingsCrafterAlertSoundDesc"]         = "Welk geluid wordt afgespeeld wanneer een crafter die je kunt bereiken online komt. Als je er een selecteert, hoor je een voorbeeld. Heeft geen effect zolang het waarschuwingsgeluid hierboven is onderdrukt."
L["SettingsCrafterAlertVisual"]            = "Waarschuwingseffect"
L["SettingsCrafterAlertVisualDesc"]        = "Welk schermeffect afgaat wanneer een crafter online komt — een schermvullende flits in de tint van je keuze, of een knippering in de taakbalk voor wanneer je weggetabt bent. Als je er een selecteert, zie je een voorbeeld. Heeft geen effect zolang de schermknippering hierboven is onderdrukt."
