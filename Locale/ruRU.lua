...
L["BrowserSkillTier"]      = "Уровень мастерства"
L["BrowserSkillTierTip"]   = "Фильтр по уровню мастерства"
L["BrowserSkillTierDesc"]  = "Показывает только рецепты отмеченных уровней мастерства. Снимите отметку с более низких уровней, чтобы скрыть их рецепты из списка. Можно отметить несколько уровней; меню остаётся открытым. Используйте «Выбрать все» / «Снять все» внизу. Рецепты без известного уровня навыка всегда остаются видимыми."
L["FilterSelectAll"]       = "Выбрать все"
L["FilterClearAll"]        = "Снять все"
L["TierApprentice"]        = "Ученик"
L["TierJourneyman"]        = "Подмастерье"
L["TierExpert"]            = "Специалист"
L["TierArtisan"]           = "Мастер"
L["TierMaster"]            = "Знаток"
L["TierGrandMaster"]       = "Великий знаток"
L["TierIllustrious"]       = "Прославленный"
L["TierZenMaster"]         = "Мастер дзен"

-- Guild tab
L["TabGuild"]               = "Гильдия"
L["GuildTabChars"]          = "Отслеживается персонажей: %d"
L["GuildColProfession"]     = "Профессия"
L["GuildColProfessionDesc"] = "Каждая профессия и сколько персонажей гильдии ею владеют. Подстроки разбивают её по специализации, если она известна."
L["GuildColCount"]          = "Персонажи"
L["GuildColCountDesc"]      = "Количество персонажей гильдии с профессией (или специализацией). Подсчитывается по синхронизированным навыкам плюс все, кто известен как создающий её рецепты."
L["GuildUnspecialized"]     = "Без специализации"
L["GuildTabEmpty"]          = "Данных о профессиях пока нет. Список заполняется по мере того, как соратники по гильдии, использующие аддон, синхронизируют свои навыки."
...
L["SettingsSyncHeader"]     = "Синхронизация"
L["SettingsGuildMode"]      = "Режим синхронизации только через гильдию (приватные серверы)"
L["SettingsGuildModeDesc"]  = "Для приватных или эмулированных серверов (например, Whitemane), которые не доставляют сообщения аддонов через шёпот, из-за чего участники гильдии не получают данные о профессиях друг друга. Когда ВКЛ, весь трафик синхронизации направляется через канал гильдии. Включайте это только если синхронизация гильдии не работает на вашем сервере. |cffffd100Включить должны все в гильдии|r — это работает только между участниками, у которых режим включён у обоих. Межгильдейский обмен автоматически отключается, пока это включено. Применяется ко всем персонажам в этом игровом мире. (Скрыто, если установленная версия DeltaSync это не поддерживает.)"
...
L["SettingsCrafterAlertSuppressAudio"]     = "Подавлять звук оповещения"
L["SettingsCrafterAlertSuppressAudioDesc"] = "Отключает звук, когда ремесленник заходит в игру (мигание экрана и сообщение в чате остаются)."
L["SettingsCrafterAlertSuppressVisual"]    = "Подавлять визуальное оповещение"
L["SettingsCrafterAlertSuppressVisualDesc"] = "Отключает визуальное оповещение на экране (мигание экрана, баннер и т. п.), когда ремесленник заходит в игру (звук и сообщение в чате остаются)."
L["AlertCrafterOnlineBanner"]              = "Гильдейский ремесленник в сети"
L["SettingsCrafterAlertSound"]             = "Звук оповещения"
L["SettingsCrafterAlertSoundDesc"]         = "Какой звук проигрывается, когда доступный вам ремесленник заходит в игру. Выбор варианта воспроизводит его для предпросмотра. Не действует, пока звук оповещения подавлен выше."
L["SettingsCrafterAlertVisual"]            = "Визуальное оповещение"
L["SettingsCrafterAlertVisualDesc"]        = "Какой экранный эффект срабатывает, когда ремесленник заходит в игру — полноэкранная вспышка выбранного вами оттенка или мигание в панели задач на случай, если вы свёрнуты (alt-tab). Выбор варианта показывает его для предпросмотра. Не действует, пока мигание экрана подавлено выше."
