...
L["BrowserSkillTier"]       = "ระดับทักษะ"
L["BrowserSkillTierTip"]    = "ตัวกรองระดับทักษะ"
L["BrowserSkillTierDesc"]   = "แสดงเฉพาะสูตรในระดับทักษะที่ทำเครื่องหมายไว้ ยกเลิกเครื่องหมายระดับที่ต่ำกว่าเพื่อซ่อนสูตรของระดับนั้นจากรายการ ทำเครื่องหมายได้หลายระดับ; เมนูจะยังคงเปิดอยู่ ใช้ เลือกทั้งหมด / ล้างทั้งหมด ที่ด้านล่าง สูตรที่ไม่ทราบระดับทักษะจะยังคงมองเห็นเสมอ"
L["FilterSelectAll"]        = "เลือกทั้งหมด"
L["FilterClearAll"]         = "ล้างทั้งหมด"
L["TierApprentice"]         = "ผู้ฝึกหัด"
L["TierJourneyman"]         = "ช่างฝีมือ"
L["TierExpert"]             = "ผู้ชำนาญ"
L["TierArtisan"]            = "ผู้เชี่ยวชาญ"
L["TierMaster"]             = "อาจารย์"
L["TierGrandMaster"]        = "ปรมาจารย์"
L["TierIllustrious"]        = "ผู้เกริกไกร"
L["TierZenMaster"]          = "อาจารย์เซน"

-- Guild tab
L["TabGuild"]               = "กิลด์"
L["GuildTabChars"]          = "ติดตามตัวละคร %d ตัว"
L["GuildColProfession"]     = "วิชาชีพ"
L["GuildColProfessionDesc"] = "แต่ละวิชาชีพและจำนวนตัวละครในกิลด์ที่มีวิชาชีพนั้น แถวย่อยจะแยกตามความเชี่ยวชาญเฉพาะทางเมื่อทราบ"
L["GuildColCount"]          = "ตัวละคร"
L["GuildColCountDesc"]      = "จำนวนตัวละครในกิลด์ที่มีวิชาชีพ (หรือความเชี่ยวชาญเฉพาะทาง) นับจากทักษะที่ซิงค์แล้วรวมกับทุกคนที่ทราบว่าคราฟต์สูตรของวิชาชีพนั้นได้"
L["GuildUnspecialized"]     = "ไม่มีความเชี่ยวชาญเฉพาะทาง"
L["GuildTabEmpty"]          = "ยังไม่มีข้อมูลวิชาชีพ ข้อมูลจะปรากฏขึ้นเมื่อเพื่อนร่วมกิลด์ที่ใช้แอดออนซิงค์ทักษะของพวกเขา"
